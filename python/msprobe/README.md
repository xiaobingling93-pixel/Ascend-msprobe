...
请参见[安装指导说明](../../docs/msprobe/01.installation.md)。

## 🌟 新版本特性

请参见[特性变更说明](../../docs/msprobe/01.installation.md#特性变更说明)。

## 🛠️ config.json [介绍](../../docs/msprobe/02.config_introduction.md) 和 [示例](../../docs/msprobe/03.config_examples.md)

## 🧰 主要功能

### 0 用前必看

使用工具前，建议先浏览[**工具功能模块简介、适用场景和当前版本局限性**](../../docs/msprobe/25.tool_function_introduction.md)，了解功能特性。

### 1 数据采集

msprobe 通过在训练脚本中添加 PrecisionDebugger 接口的方式对 API 执行精度数据 dump 操作。对应 config.json 中的 "statistics" 或 "tensor" task。

[PyTorch 场景的数据采集](../../docs/msprobe/05.data_dump_PyTorch.md)

[MindSpore 场景的数据采集](../../docs/msprobe/06.data_dump_MindSpore.md)

[MSAdapter 场景的数据采集](../../docs/msprobe/29.data_dump_MSAdapter.md)
...
[兼容 PyTorch 和 MindSpore 框架的训练状态监控](../../docs/msprobe/19.monitor.md)
...
[FAQ for PyTorch](../../docs/msprobe/FAQ.md)
