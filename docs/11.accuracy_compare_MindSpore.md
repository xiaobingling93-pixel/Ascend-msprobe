...
4. 执行如下示例命令进行比对：
   ...
   ```shell
   msprobe compare -i ./compare.json -o ./output -s -am
   ```

   或

   ```shell
   msprobe compare -i ./compare.json -o ./output -s -am api_mapping.yaml
   ```
...
4. 执行如下示例命令进行比对：
   ...
   ```shell
   msprobe compare -i ./compare.json -o ./output -s -cm
   ```

   或

   ```shell
   msprobe compare -i ./compare.json -o ./output -s -cm cell_mapping.yaml
   ```
...
4. 执行如下示例命令进行比对：
   ...
   ```shell
   msprobe compare -i ./compare.json -o ./output -s -lm layer_mapping.yaml
   ```
