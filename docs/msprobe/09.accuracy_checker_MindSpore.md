...
```bash
msprobe -f mindspore acc_check -api_info ./dump.json -o ./checker_result -save_error_data
```
...
在不同卡数下，使用38B语言大模型的预检耗时基线参考[multi_acc_check耗时基线](./mindspore_accuracy_checker_perf_baseline.md)。
